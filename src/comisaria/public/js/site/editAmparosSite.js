$(document).ready(function(){
  ...
  $('#btnCancelar').click(function (e){
    ...
    $("#fecha_recepcion").datepicker("update", fecha1);
    $("#fecha_ejecutoria").datepicker("update", fecha2);
    ...
    $.ajax({
        ...
        success: function (data){
            ...
            $.each(data, function (kay, val){
                if(abo == val.user){
                    elem.append($('<option/>', { 'value': val.user, 'text': val.nombreCompleto, selected: true }));
                } else {
