...
@section('title', 'Editar derechos humanos')
    ...
    <div class="content-area py-1">
      <div class="container-fluid">
        <div class="box box-block bg-white">
          ...
          <form id="formGuardar" method="POST" action="/derechos-humanos-edit">

            <input type="hidden" id="id" value="{{$info->id}}" />
            <input type="hidden" id="empleado" value="{{$info->abogados}}" />
            <input type="hidden" id="estado" value="{{$info->estado_procesal}}" />
            <input type="hidden" id="fecha" value="{{$info->fecha_recepcion}}" />

            <div class="row">
              <div class="col col-md-12 form-group">
                <label for="exampleTextarea">Queja</label>
              <textarea class="form-control" id="queja" name="queja" rows="3">{{$info->queja}}</textarea>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <textarea class="form-control" id="asunto" name="asunto" rows="3">{{$info->asunto}}</textarea>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <textarea class="form-control" id="derecho_violado" name="derecho_violado" rows="3">{{$info->derecho_violado}}</textarea>
              </div>
            </div>
            <div class="row">
              <div class="col col-md-12 form-group">
...
<script type="text/javascript" src="/js/site/editDerechosHumanosSite.js"></script>
@endsection