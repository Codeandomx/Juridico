        ...
        <div class="box box-block bg-white">
            <nav>
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('archivoPS') }}">Archivo</a></li>
                    <li class="breadcrumb-item active"><a href="#">AntiCorrupcion Archivo</a></li>
                </ul>
            </nav>
            ...
            <br>
            <br>
            <table id="tablaCA" class="table table-striped table-bordered dataTable" style="width: 100%;">
                <thead>
                    <tr>
                        <th>id</th>
...
<script type="text/javascript" src="js/site/AnticorrupcionArchivoSite.js"></script>
@endsection
