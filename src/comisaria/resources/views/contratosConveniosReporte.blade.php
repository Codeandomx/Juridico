...
<div class="row row-md mb-2">
    <div class="col-md-12">
        <div class="box box-block bg-white">
            ...
            <form id="formBuscar" method="POST" action="api/ContratosyConveniosReporte" autocomplete="off">
...
<script type="text/javascript" src="js/site/ContratosConveniosReporte.js"></script>
@endsection
