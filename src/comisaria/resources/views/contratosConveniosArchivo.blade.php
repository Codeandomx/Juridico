...
<div class="row row-md mb-2">
    <div class="col-md-12">
        <div class="box box-block bg-white">
            ...
            <br>
            <br>
            <table id="tablaCCA" class="table table-striped table-bordered dataTable" style="width: 100%;">
                <thead>
                    <tr>
                        <th>id</th>
...
<script type="text/javascript" src="js/site/ContratosConveniosArchivoSite.js"></script>
@endsection
