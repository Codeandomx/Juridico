...
<div class="row row-md mb-2">
    <div class="col-md-12">
        ...
        <form id="formBuscar" method="POST" action="api/AgenciasVariasReporte" autocomplete="off">
...
<script type="text/javascript" src="js/site/AgenciasVariasReporte.js"></script>
@endsection