  ...
  <div class="content-area py-1">
    <div class="container-fluid">
      <div class="box box-block bg-white">
        ...
        <form id="formAgenciasVarias" method="POST" action="{{ route('postPS') }}" autocomplete="off">
          
          <input name="tipo" type="hidden" value="agenciasVarias">

          <div class="row">

            <div class="col col-md-4 form-group">
              <label for="Numero consecutivo">Expediente</label>
            ...
            <div class="col col-md-4 form-group">
              <label for="Numero consecutivo">Carpeta de Administrativa</label>
          ...
          <div class="row">
            ...
            <div class="col col-md-4 form-group">
              <label for="Carpeta de investigación">Averiguación previa</label>
...
<script type="text/javascript" src="_vendor/jquery-validate/jquery-validate.js"></script>
<script type="text/javascript" src="_vendor/jquery-validate/additional-methods.min.js"></script>
<script type="text/javascript" src="js/site/formAgenciasVariasSite.js"></script>
@endsection
