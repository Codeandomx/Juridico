...
@section('title', 'Reporte Transparencia')
...
<div class="row row-md mb-2">
    <div class="col-md-12">
        <div class="box box-block bg-white">
            ...
            <br>
            <br>
            <form id="formBuscar" method="POST" action="api/transparenciareporte">
...
<script type="text/javascript" src="js/site/transparenciaReporteSite.js"></script>
@endsection
